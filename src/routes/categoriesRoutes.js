...
import { getAllBooks, searchBooks, getAllCategories, getBooksByCategory, getBookById, addToCart, createBook, updateBook, deleteBook } from "../controllers/categoriesControllers.js";
const router = Router();
// Public Book Routes
