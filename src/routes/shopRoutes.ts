...
import {getAllBooks,getBookById,searchBooks,createBook,updateBook,deleteBook,createOrder,getAllOrders,getOrderById, updateOrderStatus} from
("../controllers/shopControllers");
const router = Router();
// Book Routes
...
router.get('/books/:id', getBookById);                // GET /api/shop/books/1
